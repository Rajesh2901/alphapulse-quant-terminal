        ...
        if self.client:
            try:
                prompt = self._construct_prompt(
                    symbol, asset_name, latest_price, price_change_pct,
                    technical_data, signal_data, arima_data, ml_data,
                    risk_data, order_book_data
                )
                ...
                logger.warning(f"Gemini API request failed: {e}. Falling back to rule-based quant brief.")

        return self._generate_heuristic_brief(
            symbol, asset_name, latest_price, price_change_pct,
            signal_data, arima_data, ml_data, risk_data, order_book_data
        )
